...
<title>
	...
	<script type="text/javascript" src="<%=syspath%>/teaching/kaopin.js"></script>
</head>
<body>
		<!-- 是否是管理员 -->
		...
		<div id="search_div_id">
			<table class="Mytable">
				<tr>
					...
					<td>
						<c:if test="${admin }">
							<button class="Printbotton" onclick="printEmptyKaopin()">
								<img src="imgs/print.png" style="margin-right: 5px;">班级空白考评表
							</button>
						</c:if>
					</td>
				</tr>
