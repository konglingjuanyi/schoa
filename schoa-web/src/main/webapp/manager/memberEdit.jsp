...
<title></title>
	<script type="text/javascript" src="<%=syspath%>/manager/memberEdit.js"></script>
</head>
<body>
<div id="div_panel_id">
			...
			<td>
				<select id="teacherId" name="teacherId">
					...
					<c:forEach items="${teachers }" var="teacher">
						<option <c:if test="${teacher.id == member.teacherId }">selected="selected"</c:if>  value="${teacher.id}">${teacher.name}
					</c:forEach>
				</select>
			</td>
		</tr>
