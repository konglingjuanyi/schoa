...
/**
  */
public class QuestionMaterialsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.hao.schoa.po.map.QuestionMaterialsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("question_materials");
        TableMap tMap = dbMap.getTable("question_materials");
        tMap.setJavaName("QuestionMaterials");
        tMap.setOMClass( com.hao.schoa.po.QuestionMaterials.class );
        tMap.setPeerClass( com.hao.schoa.po.QuestionMaterialsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("schoa");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("question_materials_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("question_materials");
        }
