...
// Local classes
import com.hao.schoa.po.map.JixiaoWaipinMapBuilder;
...
/**
 */
public abstract class BaseJixiaoWaipinPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(JixiaoWaipinMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(JixiaoWaipinMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "schoa";
        TABLE_NAME = "jixiao_waipin";

        ID = "jixiao_waipin.id";
        YOUXIU = "jixiao_waipin.youxiu";
        XUEQI_ID = "jixiao_waipin.xueqi_id";
        TEACHER_ID = "jixiao_waipin.teacher_id";
        TEACHER_NAME = "jixiao_waipin.teacher_name";
        SC_KAIHUI = "jixiao_waipin.sc_kaihui";
        SC_KAIHUI_REASON = "jixiao_waipin.sc_kaihui_reason";
        SC_HUODONG = "jixiao_waipin.sc_huodong";
        SC_HUODONG_REASON = "jixiao_waipin.sc_huodong_reason";
        SC_YINXIANG = "jixiao_waipin.sc_yinxiang";
        SC_YINXIANG_REASON = "jixiao_waipin.sc_yinxiang_reason";
        SC_GONGXIAN = "jixiao_waipin.sc_gongxian";
        SC_GONGXIAN_REASON = "jixiao_waipin.sc_gongxian_reason";
        REMARK = "jixiao_waipin.remark";
        MEMBER_ID = "jixiao_waipin.member_id";
        MEMBER_NAME = "jixiao_waipin.member_name";
        UPDATE_TIME = "jixiao_waipin.update_time";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(JixiaoWaipinMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(JixiaoWaipinMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static JixiaoWaipin row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            JixiaoWaipin obj = (JixiaoWaipin) cls.newInstance();
            JixiaoWaipinPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setScKaihui(row.getValue(offset + 5).asDouble());
            obj.setScKaihuiReason(row.getValue(offset + 6).asString());
            obj.setScHuodong(row.getValue(offset + 7).asDouble());
            obj.setScHuodongReason(row.getValue(offset + 8).asString());
            obj.setScYinxiang(row.getValue(offset + 9).asDouble());
            obj.setScYinxiangReason(row.getValue(offset + 10).asString());
            obj.setScGongxian(row.getValue(offset + 11).asDouble());
            obj.setScGongxianReason(row.getValue(offset + 12).asString());
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(JixiaoWaipinPeer.row2Object(row, 1,
                JixiaoWaipinPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(JixiaoWaipin obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(JixiaoWaipin obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(JixiaoWaipin obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(JixiaoWaipin obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(JixiaoWaipin) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(JixiaoWaipin obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(JixiaoWaipin) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(JixiaoWaipin obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(JixiaoWaipin) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(JixiaoWaipin obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( JixiaoWaipin obj )
    {
    ...
    public static Criteria buildSelectCriteria( JixiaoWaipin obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static JixiaoWaipin retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static JixiaoWaipin retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static JixiaoWaipin retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        JixiaoWaipin retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static JixiaoWaipin retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
