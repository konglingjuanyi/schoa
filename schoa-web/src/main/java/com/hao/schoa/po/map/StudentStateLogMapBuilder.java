...
/**
  */
public class StudentStateLogMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.hao.schoa.po.map.StudentStateLogMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("student_state_log");
        TableMap tMap = dbMap.getTable("student_state_log");
        tMap.setJavaName("StudentStateLog");
        tMap.setOMClass( com.hao.schoa.po.StudentStateLog.class );
        tMap.setPeerClass( com.hao.schoa.po.StudentStateLogPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("schoa");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("student_state_log_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("student_state_log");
        }
