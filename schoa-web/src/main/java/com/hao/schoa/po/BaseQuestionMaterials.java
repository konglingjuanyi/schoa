 ...
 * extended all references should be to QuestionMaterials
 */
public abstract class BaseQuestionMaterials extends BaseObject
{
    /** The Peer class */
    private static final QuestionMaterialsPeer peer =
        new QuestionMaterialsPeer();
    ...
    {
        if (name.equals(QuestionMaterialsPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(QuestionMaterialsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(QuestionMaterialsPeer.DIRECTIONS))
        {
            return getDirections();
        }
        if (name.equals(QuestionMaterialsPeer.CREATE_TIME))
        {
            return getCreateTime();
        }
        if (name.equals(QuestionMaterialsPeer.CREATE_MEMBER_ID))
        {
            return new Integer(getCreateMemberId());
        }
        if (name.equals(QuestionMaterialsPeer.CREATE_MEMBER))
        {
            return getCreateMember();
        }
        if (name.equals(QuestionMaterialsPeer.MODIFY_TIME))
        {
            return getModifyTime();
        }
        if (name.equals(QuestionMaterialsPeer.MODIFY_MEMBER_ID))
        {
            return new Integer(getModifyMemberId());
        }
        if (name.equals(QuestionMaterialsPeer.MODIFY_MEMBER))
        {
            return getModifyMember();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (QuestionMaterialsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (QuestionMaterialsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (QuestionMaterialsPeer.DIRECTIONS.equals(name))
        {
            return setByName("Directions", value);
        }
      if (QuestionMaterialsPeer.CREATE_TIME.equals(name))
        {
            return setByName("CreateTime", value);
        }
      if (QuestionMaterialsPeer.CREATE_MEMBER_ID.equals(name))
        {
            return setByName("CreateMemberId", value);
        }
      if (QuestionMaterialsPeer.CREATE_MEMBER.equals(name))
        {
            return setByName("CreateMember", value);
        }
      if (QuestionMaterialsPeer.MODIFY_TIME.equals(name))
        {
            return setByName("ModifyTime", value);
        }
      if (QuestionMaterialsPeer.MODIFY_MEMBER_ID.equals(name))
        {
            return setByName("ModifyMemberId", value);
        }
      if (QuestionMaterialsPeer.MODIFY_MEMBER.equals(name))
        {
    ...
    {
        save(QuestionMaterialsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    QuestionMaterialsPeer.doInsert((QuestionMaterials) this, con);
                    setNew(false);
                }
                else
                {
                    QuestionMaterialsPeer.doUpdate((QuestionMaterials) this, con);
                }
            }
     ...
     */
    public QuestionMaterials copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public QuestionMaterials copy(Connection con) throws TorqueException
    {
     ...
     */
    public QuestionMaterials copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new QuestionMaterials(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public QuestionMaterials copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new QuestionMaterials(), deepcopy, con);
    }
     ...
     */
    protected QuestionMaterials copyInto(QuestionMaterials copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected QuestionMaterials copyInto(QuestionMaterials copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected QuestionMaterials copyInto(QuestionMaterials copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected QuestionMaterials copyInto(QuestionMaterials copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setName(name);
        copyObj.setDirections(directions);
     ...
     */
    public QuestionMaterialsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return QuestionMaterialsPeer.getTableMap();
    }
