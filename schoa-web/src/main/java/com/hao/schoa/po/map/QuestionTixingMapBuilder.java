...
/**
  */
public class QuestionTixingMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.hao.schoa.po.map.QuestionTixingMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("question_tixing");
        TableMap tMap = dbMap.getTable("question_tixing");
        tMap.setJavaName("QuestionTixing");
        tMap.setOMClass( com.hao.schoa.po.QuestionTixing.class );
        tMap.setPeerClass( com.hao.schoa.po.QuestionTixingPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("schoa");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("question_tixing_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("question_tixing");
        }
  ...
  // ------------- Column: title --------------------
        ...
        cMap.setProtected(false);
        cMap.setDescription("标题");
        cMap.setInheritance("false");
        cMap.setSize( 80 );
        cMap.setPosition(2);
        tMap.addColumn(cMap);
  // ------------- Column: subtitle --------------------
        cMap = new ColumnMap( "subtitle", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "VARCHAR" );
        cMap.setUsePrimitive(true);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "Subtitle" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("副标题");
        cMap.setInheritance("false");
        cMap.setSize( 200 );
        cMap.setPosition(3);
        tMap.addColumn(cMap);
  // ------------- Column: standard_info --------------------
        cMap = new ColumnMap( "standard_info", tMap);
        cMap.setType( "" );
        cMap.setTorqueType( "VARCHAR" );
        cMap.setUsePrimitive(true);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "StandardInfo" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("评分标准");
        cMap.setInheritance("false");
        cMap.setSize( 200 );
        cMap.setPosition(4);
        tMap.addColumn(cMap);
