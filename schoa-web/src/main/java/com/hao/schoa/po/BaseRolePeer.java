...
// Local classes
import com.hao.schoa.po.map.RoleMapBuilder;
    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(RoleMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(RoleMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(RoleMapBuilder.CLASS_NAME);
            }
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setIntro(row.getValue(offset + 2).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
