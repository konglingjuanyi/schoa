...
// Local classes
import com.hao.schoa.po.map.JixiaoZaibianMapBuilder;
...
/**
 */
public abstract class BaseJixiaoZaibianPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(JixiaoZaibianMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(JixiaoZaibianMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "schoa";
        TABLE_NAME = "jixiao_zaibian";

        ID = "jixiao_zaibian.id";
        YOUXIU = "jixiao_zaibian.youxiu";
        XUEQI_ID = "jixiao_zaibian.xueqi_id";
        TEACHER_ID = "jixiao_zaibian.teacher_id";
        TEACHER_NAME = "jixiao_zaibian.teacher_name";
        SC_KAIHUI_REASON = "jixiao_zaibian.sc_kaihui_reason";
        SC_BANZHUREN = "jixiao_zaibian.sc_banzhuren";
        SC_JIANREN = "jixiao_zaibian.sc_jianren";
        SC_OTHER = "jixiao_zaibian.sc_other";
        SC_JIANG = "jixiao_zaibian.sc_jiang";
        SC_GONGZUOLIANG = "jixiao_zaibian.sc_gongzuoliang";
        SC_KAOHE_FILE = "jixiao_zaibian.sc_kaohe_file";
        SC_KAOHE_FILENAME = "jixiao_zaibian.sc_kaohe_filename";
        REMARK = "jixiao_zaibian.remark";
        MEMBER_ID = "jixiao_zaibian.member_id";
        MEMBER_NAME = "jixiao_zaibian.member_name";
        UPDATE_TIME = "jixiao_zaibian.update_time";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(JixiaoZaibianMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(JixiaoZaibianMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.hao.schoa.po.JixiaoZaibian";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static JixiaoZaibian row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            JixiaoZaibian obj = (JixiaoZaibian) cls.newInstance();
            JixiaoZaibianPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTeacherName(row.getValue(offset + 4).asString());
            obj.setScKaihuiReason(row.getValue(offset + 5).asString());
            obj.setScBanzhuren(row.getValue(offset + 6).asString());
            obj.setScJianren(row.getValue(offset + 7).asString());
            obj.setScOther(row.getValue(offset + 8).asString());
            obj.setScJiang(row.getValue(offset + 9).asString());
            obj.setScGongzuoliang(row.getValue(offset + 10).asString());
            obj.setScKaoheFile(row.getValue(offset + 11).asString());
            obj.setScKaoheFilename(row.getValue(offset + 12).asString());
            obj.setRemark(row.getValue(offset + 13).asString());
            obj.setMemberId(row.getValue(offset + 14).asInt());
            obj.setMemberName(row.getValue(offset + 15).asString());
            obj.setUpdateTime(row.getValue(offset + 16).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(JixiaoZaibianPeer.row2Object(row, 1,
                JixiaoZaibianPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(JixiaoZaibian obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(JixiaoZaibian obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(JixiaoZaibian obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(JixiaoZaibian obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(JixiaoZaibian) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(JixiaoZaibian obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(JixiaoZaibian) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(JixiaoZaibian obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(JixiaoZaibian) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(JixiaoZaibian obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( JixiaoZaibian obj )
    {
    ...
    public static Criteria buildSelectCriteria( JixiaoZaibian obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static JixiaoZaibian retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static JixiaoZaibian retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static JixiaoZaibian retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        JixiaoZaibian retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static JixiaoZaibian retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
