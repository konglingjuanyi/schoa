...
// Local classes
import com.hao.schoa.po.map.MemberMapBuilder;
    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(MemberMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(MemberMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the show_name field */
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(MemberMapBuilder.CLASS_NAME);
            }
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PWD);
        criteria.addSelectColumn(SHOW_NAME);
        ...
        throws TorqueException
    {
        try
        {
            ...
            MemberPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setValid(row.getValue(offset + 2).asInt());
            obj.setPwd(row.getValue(offset + 3).asString());
            obj.setShowName(row.getValue(offset + 4).asString());
            obj.setRoleId(row.getValue(offset + 5).asInt());
            obj.setPhone(row.getValue(offset + 6).asString());
            obj.setEmail(row.getValue(offset + 7).asString());
            obj.setTeacherId(row.getValue(offset + 8).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
    ...
    public static Criteria buildCriteria( Member obj )
    {
        ...
        criteria.add(PWD, obj.getPwd());
        criteria.add(SHOW_NAME, obj.getShowName());
    ...
    public static Criteria buildSelectCriteria( Member obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static Member retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Member retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
