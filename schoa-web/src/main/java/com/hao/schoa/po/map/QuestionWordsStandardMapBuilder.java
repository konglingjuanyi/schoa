...
/**
  */
public class QuestionWordsStandardMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.hao.schoa.po.map.QuestionWordsStandardMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("question_words_standard");
        TableMap tMap = dbMap.getTable("question_words_standard");
        tMap.setJavaName("QuestionWordsStandard");
        tMap.setOMClass( com.hao.schoa.po.QuestionWordsStandard.class );
        tMap.setPeerClass( com.hao.schoa.po.QuestionWordsStandardPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("schoa");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("question_words_standard_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("question_words_standard");
        }
